          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Form Elements">Atur barang</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="{{ route('barangmasuk.index')}}" class="menu-link">
                    <div data-i18n="Input groups">Barang masuk</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ route('barangkeluar.index')}}" class="menu-link">
                    <div data-i18n="Input groups">Barang keluar</div>
                  </a>
                </li>
                 <li class="menu-item">
                  <a href="{{ route('barangpeminjam.index')}}" class="menu-link">
