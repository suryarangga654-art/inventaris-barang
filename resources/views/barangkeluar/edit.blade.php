                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">edit Data Keluar Barang</h5>
                    </div>
                    <div class="card-body">
                      <form action="{{ route('barangkeluar.update', $keluar->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-10">
                          ...
                          <select class="form-select" name="id_barang" id="id_barang">
                            ...
                            <option value="{{$data->id}}"{{ $keluar->id_barang == $data->id ? 'selected' : '' }}>{{$data->name_barang}}</option>
                            @endforeach
                          </select>
                        </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input
                                type="text" class="form-control" name="merek" value="{{ $keluar->merek}}"/>
                            </div>
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-company2" class="input-group-text"><i class="bx bx-store"></i></span>
                              <input
                                type="number" class="form-control" name="jumlah" value="{{ $keluar->jumlah}}"/>
                            </div>
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-company2" class="input-group-text"><i class="bx bx-store"></i></span>
                              <input
                                type="text" class="form-control" name="keterangan" value="{{ $keluar->keterangan}}"/>
                            </div>
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-company2" class="input-group-text"><i class="bx bx-store"></i></span>
                              <input
                                type="date" class="form-control" name="tanggal_barang_keluar" value="{{ $keluar->tanggal_barang_keluar}}"/>
                            </div>
                          </div>
                        </div>
