                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">Buat Data pengembalian Barang</h5>
                    </div>
                    <div class="card-body">
                      <form action="{{ route('barangpengembalian.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                      <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input
                                type="text" class="form-control" name="nama_pengembali" placeholder="Nama Pengembali"/>
                            </div>
                          </div>
                        </div>
                        <div class="row mb-3">
