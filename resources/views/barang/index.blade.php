                        ...
                        <td>
                          <div class="">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="{{ route('barang.show',$data->id)}}"><i class="bx bx-show-alt me-2"></i> Show</a>
                              <a class="dropdown-item" href="{{ route('barang.edit',$data->id)}}"><i class="bx bx-edit-alt me-2"></i> Edit</a>
